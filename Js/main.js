...
function changeModel(modelNumber) {
    ...
    switch (modelNumber) {
        case 1:
            document.getElementById(`bgCircle`).style.background = "#3B556B";
            document.getElementById(`smlCircle`).style.background = "#D17E6565";
            ...
            document.getElementById(`description`).innerHTML = `The Nike SB Dunk High Pro QS 'Hawaii Maui Wowie' embodies tropical flair with its vibrant floral print and hidden stash pocket. Designed for skaters, it features a durable canvas upper, padded collar, and Zoom Air cushioning for optimal support and comfort. A standout choice for both skating and street style.`
            document.getElementById(`btn`).style.backgroundColor = "#D17E65"
            document.getElementById(`btn1`).style.backgroundColor = "#D17E65"
            break;

        case 2:
            document.getElementById(`bgCircle`).style.background = "#71D68F";
            document.getElementById(`smlCircle`).style.background = "#A0A0A0";
        ...
        case 3:
            document.getElementById(`bgCircle`).style.background = "#5C484F";
            document.getElementById(`smlCircle`).style.background = "#BBE99E";
        ...
        case 4:
            document.getElementById(`bgCircle`).style.background = "#857D73";
            document.getElementById(`smlCircle`).style.background = "#FFBC2C6E";
        ...
        case 5:
            document.getElementById(`bgCircle`).style.background = "#8B8FC9";
            document.getElementById(`smlCircle`).style.background = "#ECBB86";
        ...
        case 6:
            document.getElementById(`bgCircle`).style.background = "#D89898";
            document.getElementById(`smlCircle`).style.background = "#BD626267";
